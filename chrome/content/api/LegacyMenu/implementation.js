...
createNode(document) {
    ...
    item.setAttribute("id", this.id);
    if (typeof (this.collapsed) !== "undefined" || this.collapsed !== null)
  ...
  function createWidget(widget, context) {
    ...
    if (widget.type === "menu-label")
      return new MenuLabel(widget.id, widget.label, widget.accesskey, widget.labelType, widget.checked);
    ...
    if (widget.type === "appmenu-label")
      ...
      return new ToolbarButton(widget.id, widget.label, widget.accesskey, widget.image, widget.tooltip);

      if (widget.type === "toolbarMenuButton")
      return new ToolbarMenuButton(widget.id, widget.label, widget.accesskey, widget.image, widget.tooltip);


      if (widget.type === "toolbarseparator")
      return new ToolbarSeparator(widget.id, widget.label, widget.accesskey);

      if (widget.type === "hbox")
      return new HBox(widget.id, widget.collapsed, widget.accesskey, widget.style);
