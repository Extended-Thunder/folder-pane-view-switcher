...
var ADDON_ID = "FolderPaneSwitcher@kamens.us";
...
var notifyTools = {
    ...
    onNotifyExperimentObserver: {
        observe: async function (aSubject, aTopic, aData) {
            ...
            if (payload.resolve) {
                ...
                console.log(
                    "Please update the notifyTools API to at least v1.5"
                );
                for (let registeredCallback of Object.values(
                    notifyTools.registeredCallbacks
                )) {
    ...
    enable: function () {
        console.log(
            "Manually calling notifyTools.enable() is no longer needed."
        );
    },

    disable: function () {
        console.log(
            "notifyTools.disable() has been deprecated, use notifyTools.removeAllListeners() instead."
        );
    ...
    registerListener: function (listener) {
        console.log(
            "notifyTools.registerListener() has been deprecated, use notifyTools.addListener() instead."
        );
